...
export default function Search() {
  ...
  return (
    <div className='flex flex-col md:flex-row'>
      <div className='p-7 border-1 md:border-r md:min-h-screen border-gray-300'>
        <form className='flex flex-col gap-8' onSubmit={handleSubmit}>
          ...
          <div className='flex items-center gap-2'>
            ...
            >
              ...
              <option value='Range Query'>Range Query</option>
              <option value='Rolling Hash'>Rolling Hash</option>
              <option value='Searching'>Searching</option>
              <option value='Trie'>Trie</option>
              <option value='Binary Lifting'>Binary Lifting</option>
